...
module.exports = {
    ...
    getMetricValue: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestores/{timestoreId}/entities/{entityId}/metrics/:metricName/{targetDate}", options);
        options.verb = "get";
        chumblRequest(options, callback);
    },
    ...
    incrementMetricValues: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestores/{timestoreId}/entities/{entityId}/metrics/:metricName/increment/{targetDate}", options);
        options.data = options.values || options.data;
        options.verb = "post";
        chumblRequest(options, callback);
    },
