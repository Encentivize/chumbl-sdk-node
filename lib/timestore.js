...
module.exports = {
    ...
    getTimestoreMetrics: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestores/metrics/{targetDate}", options);
        options.verb = "get";
        options.errorIfNoResult = true;
        chumblRequest(options, callback);
    },
    countTimestoreMetrics: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestores/metrics/count/{targetDate}", options);
        options.verb = "get";
        options.errorIfNoResult = true;
        chumblRequest(options, callback);
    },
    aggregateTimestoreMetrics: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestores/metrics/aggregate/{targetDate}", options);
        options.verb = "get";
        options.errorIfNoResult = true;
        chumblRequest(options, callback);
    },
    getTimestoreMetricsForEntity: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestores/entities/{entityId}/metrics/{targetDate}", options);
        options.verb = "get";
        options.errorIfNoResult = true;
        chumblRequest(options, callback);
    },
    countTimestoreMetricsForEntity: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestores/entities/{entityId}/metrics/count/{targetDate}", options);
        options.verb = "get";
        options.errorIfNoResult = true;
        chumblRequest(options, callback);
    },
    aggregateTimestoreMetricsForEntity: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestores/entities/{entityId}/metrics/aggregate/{targetDate}", options);
        options.verb = "get";
        options.errorIfNoResult = true;
        chumblRequest(options, callback);
    },
