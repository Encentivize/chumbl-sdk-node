...
var inventory = {
    ...
    lockRandomInventoryItem:function(options,callback){
        var url=url="/{chumblr}/inventories/{inventoryId}/entities/{entityId}/items/randomLock";
        if (options.query){
            url+="?" + options.query;
        }
        options.url=url;
    ...
    transferInventoryItem:function(options,callback){
        var url=url="/{chumblr}/inventories/{inventoryId}/entities/{entityId}/items/{itemId}/{toInventoryId}/{toEntityId}";
        if (options.query){
            url+="?" + options.query;
        }
        options.url=url;
