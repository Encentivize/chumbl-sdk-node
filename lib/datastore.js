...
module.exports = {
    ...
    countDatastoreValues: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/datastores/{datastoreId}/values/count", options);
        options.verb = "get";
        options.errorIfNoResult=true;
        chumblRequest(options, callback);
    },
    ...
    aggregateAllDatastores: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/datastores/values/aggregate", options);
        options.verb = "get";
        options.errorIfNoResult=true;
        chumblRequest(options, callback);
    },
    countAllDatastores: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/datastores/values/count", options);
        options.verb = "get";
        options.errorIfNoResult=true;
        chumblRequest(options, callback);
    },
