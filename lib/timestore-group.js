...
module.exports = {
    ...
    deleteTimestoreGroup: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestoregroups/{timestoreGroupId}", options);
        options.verb = "delete";
        chumblRequest(options, callback);
    },
    ...
    aggregateTimestoreGroupMetrics: function (options, callback) {
        options.url = queryBuilder("/{chumblr}/timestoregroups/{timestoreGroupId}/aggregate/{targetDate}", options);
        options.verb = "get";
        options.errorIfNoResult = true;
        chumblRequest(options, callback);
    }
